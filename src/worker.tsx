...
const AppLayoutWithContentLayout = ({ children }: LayoutProps) => <ContentLayout>{children}</ContentLayout>

const ChatAgentWithContentLayout = () => <ContentLayout><ChatAgent /></ContentLayout>

...
import { ChatLayoutWithContentLayout } from '../shared/ChatLayoutWithContentLayout'
import { getMessages, newMessage, clearMessages } from './client-functions'
import type { Message } from '../shared/ChatStore'
import { useAgent } from 'agents/react'

export function ChatAgentWithContentLayout() {
  ...
  return (
    <ChatLayoutWithContentLayout title="RedwoodSDK Agent Chat">
      <MessageList messages={messages} />
      <MessageInput newMessage={newMessage} onClear={clearMessages} />
    </ChatLayoutWithContentLayout>
  )
}
